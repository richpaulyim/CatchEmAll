...
mahal_dist_matrix <- readRDS("data_clustering/clustering_results/mahalanobis_distance_matrix.rds")
...
ggsave("data_clustering/clustering_results/distance_distribution.png",
       p1, width = 10, height = 6, dpi = 300)
cat("  Saved: distance_distribution.png\n")

ggsave("data_clustering/clustering_results/affinity_distributions.png",
       p2, width = 10, height = 6, dpi = 300)
cat("  Saved: affinity_distributions.png\n")

# Save summary table
write_csv(sparsity_summary, "data_clustering/clustering_results/sparsity_summary.csv")
cat("  Saved: sparsity_summary.csv\n")

cat("\nDone! Check data_clustering/clustering_results/ for results.\n")
